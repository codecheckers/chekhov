...
var registry = []Definition{
	...
	{
		Name:    Accept,
		Summary: "Adopt the record of this check - roles, certificate - after somebody edited it",
		Usage:   "accept record",
		Group:   GroupPeople,
		Role:    RoleEditor,
	},
	...
	},
	{
		...
		Usage:   "check [config|metadata [references]|bundle|report|register|repository] <repository, or certificate>",
